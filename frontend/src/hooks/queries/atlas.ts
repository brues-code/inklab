...
const GetLoot = (category: string, instance: string, boss: string): Promise<main.LegacyBossLoot | null> =>
    window?.go?.main?.App?.GetLoot ? window.go.main.App.GetLoot(category, instance, boss) : Promise.resolve(null)
