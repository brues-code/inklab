export namespace main {
	...
	export class FlightConnection {
	    ...
	    static createFrom(source: any = {}) {
	        return new FlightConnection(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.pathId = source["pathId"];
	        this.from = source["from"];
	        this.to = source["to"];
	        this.waypoints = source["waypoints"];
	    }
	}
	export class FlightContinent {
	    mapId: number;
	    name: string;
	
	    static createFrom(source: any = {}) {
	        return new FlightContinent(source);
	    }
	...
	export class GatheringSpawn {
	    zone: string;
	    x: number;
	    y: number;
	
	    static createFrom(source: any = {}) {
	        return new GatheringSpawn(source);
	    }
	...
	export class GatheringNode {
	    ...
	    reqSkill: number;
	    entries: number[];
	    spawns: GatheringSpawn[];
	
	    static createFrom(source: any = {}) {
	        return new GatheringNode(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.spawns = this.convertValues(source["spawns"], GatheringSpawn);
	    }
	...
	export class GatheringProfession {
	    id: number;
	    name: string;
	    nodes: number;
	    spawns: number;
	    ...
	    static createFrom(source: any = {}) {
	        return new GatheringProfession(source);
	    }
	...
	export class IconUsageSpell {
	    entry: number;
	    name: string;
	    rank: string;
	
	    static createFrom(source: any = {}) {
	        return new IconUsageSpell(source);
	    }
	...
	export class IconUsageItem {
	    entry: number;
	    name: string;
	    quality: number;
	
	    static createFrom(source: any = {}) {
	        return new IconUsageItem(source);
	    }
	...
	export class IconUsage {
	    name: string;
	    items: IconUsageItem[];
	    spells: IconUsageSpell[];
	
	    static createFrom(source: any = {}) {
	        return new IconUsage(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.name = source["name"];
	        this.items = this.convertValues(source["items"], IconUsageItem);
	        this.spells = this.convertValues(source["spells"], IconUsageSpell);
	    }
	...
	export class WhatsNewEntry {
	    ...
	    static createFrom(source: any = {}) {
	        return new WhatsNewEntry(source);
	    }
	...
	export class WhatsNewGroup {
	    ...
	    static createFrom(source: any = {}) {
	        return new WhatsNewGroup(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.entries = this.convertValues(source["entries"], WhatsNewEntry);
	    }
	...
	export class WhatsNewReport {
	    baseline: string;
	    groups: WhatsNewGroup[];
	    error?: string;
	
	    static createFrom(source: any = {}) {
	        return new WhatsNewReport(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.baseline = source["baseline"];
	        this.groups = this.convertValues(source["groups"], WhatsNewGroup);
	        this.error = source["error"];
	    }
...
export namespace models {
	...
	export class GameObjectDetail {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.reqSkill = source["reqSkill"];
	        this.reqSkillLevel = source["reqSkillLevel"];
	        this.startsQuests = this.convertValues(source["startsQuests"], QuestRelation);
	        this.endsQuests = this.convertValues(source["endsQuests"], QuestRelation);
	...
	export class SpellEffectInfo {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.createdItem = this.convertValues(source["createdItem"], SpellUsedByItem);
	    }
	...
	export class ZoneListEntry {
	    ...
	    static createFrom(source: any = {}) {
	        return new ZoneListEntry(source);
	    }
